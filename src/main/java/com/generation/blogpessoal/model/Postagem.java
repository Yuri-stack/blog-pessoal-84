...
public class Postagem {
	...
	@Id	// Defini a chave primária
	@GeneratedValue(strategy = GenerationType.IDENTITY)	// Defini que o campo é preenchido pelo banco | De forma incremental
	...
	private LocalDateTime data;	// 21/5 12:35 -> 21/5 12:45
